...
$(function() {
    ...
    $("[data-timer]").each(function () {
        ...
        $this.countdown({
            ...
            layout:'{desc}<div class="col-4">{d<}<div class="number green"><span>{dn}</span></div><div class="name">{dl}</div></div>  {d>}'+ 
            ' <div class="col-4"><div class="number blue"><span>{hn}</span></div> <div class="name">{hl}</div></div><div class="col-4"> <div class="number yellow"><span>{mn}</span></div> <div class="name">{ml}</div></div>',
